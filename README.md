...
项目目前处于从零重建的实验阶段，已完成 M0-S001—M0-S007，并按 S001 1.6 重新冻结正式 Runtime CLI、受信环境根、组合清单和 blocked/not-ready 生命周期边界。当前仍只有可复现工程底座，没有数据库 schema、HTTP 服务入口、产品能力或可运行版本；M0-S008 已获实施授权，尚未完成 Runtime 钢架接线。
