...
| 数据库 | PostgreSQL 18.4、pgvector 0.8.6、pg_trgm 1.6；唯一 Alembic `0000`；baseline `armi.schema-baseline.v63`，只维护最新数据库 |
| 物理 schema | 当前 baseline 60 张表；字段以 packaged SQL 为准，表和生产 DML 都受 owner registry 检查 |
