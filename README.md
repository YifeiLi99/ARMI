...
项目目前处于从零重建的实验阶段，已完成 M0-S001—M0-S005；S001 1.4 已重新冻结 `armi.runtime-config.v1` 的字段、覆盖、摘要、脱敏和秘密 locator 规则，M0-S006 已获授权并正在实施。当前仍只有可复现工程底座，没有产品能力、服务入口或可运行版本；M0-S007 尚未授权。
