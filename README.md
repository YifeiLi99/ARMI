...
项目当前已达到 M0-Core 单机个人内测可用，P0-S001—S022 已完成，P0 核心旅程已在单机隔离环境通过。P1-S001—S007 已完成功能实现，下一施工入口为 P1-S008。Creator 现在可以维护自己的 Prompt，并创建、切换、关闭或重开多个近期现场彼此隔离的场合；这些场合继续共享同一个 ARMI 的主体、记忆、关系和活动。ARMI 能基于同轮真实 Experience 选择结构化的认知、表达和反思方法，主动查询获准生活记录，让持有注意的 `in_progress` Activity 完成一次有界内部工作，也能在睡眠阶段对仍可自然访问的记忆作实质维护并核对当前主体、关系和活动状态。维护变化与无变化均经 T-03 结算，自检问题只向 Creator 提供不含私人正文的高层说明；该链路不接网页、外部工具、账号或新执行器。P0 通过不代表生产发布；P1 当前仍只包含 18 个内部功能步骤，外部程序、安全、部署、迁移和发布等待创造者指导后另行规划。
