...
`codex_result_rejected`，不再遗留 pending 责任。P1 将先按 P1-S001—S042 补齐 01—06 的
全部设计功能，再在 P1-S043—S048 集中处理整合、安全、稳定性和发布候选。
