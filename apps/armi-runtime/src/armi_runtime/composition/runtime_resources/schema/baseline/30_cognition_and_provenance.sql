...
CREATE TABLE armi.cognitive_attempts (
    ...
    CONSTRAINT cognitive_attempts_candidate_schema_version_check CHECK ((candidate_schema_version = ANY (ARRAY['armi.cognition-candidate.v1'::text, 'armi.cognition-candidate.v2'::text, 'armi.cognition-candidate.v3'::text, 'armi.cognition-candidate.v4'::text, 'armi.cognition-candidate.v5'::text, 'armi.cognition-candidate.v6'::text, 'armi.cognition-candidate.v7'::text, 'armi.creator-dialogue-candidate.v5'::text, 'armi.creator-dialogue-candidate.v6'::text, 'armi.creator-dialogue-candidate.v7'::text, 'armi.creator-dialogue-candidate.v8'::text, 'armi.creator-dialogue-candidate.v9'::text, 'armi.creator-dialogue-candidate.v10'::text, 'armi.creator-dialogue-candidate.v11'::text, 'armi.creator-dialogue-candidate.v12'::text, 'armi.creator-dialogue-candidate.v13'::text, 'armi.creator-dialogue-candidate.v14'::text, 'armi.creator-dialogue-candidate.v15'::text, 'armi.creator-dialogue-candidate.v16'::text, 'armi.creator-dialogue-candidate.v17'::text, 'armi.creator-dialogue-candidate.v18'::text, 'armi.creator-dialogue-candidate.v19'::text, 'armi.creator-dialogue-candidate.v20'::text, 'armi.creator-dialogue-candidate.v21'::text, 'armi.creator-dialogue-candidate.v22'::text, 'armi.creator-response-candidate.v1'::text, 'armi.creator-appraisal-candidate.v1'::text, 'armi.creator-appraisal-candidate.v2'::text, 'armi.creator-appraisal-candidate.v3'::text, 'armi.creator-appraisal-candidate.v4'::text, 'armi.autonomous-activity-candidate.v1'::text, 'armi.autonomous-activity-candidate.v2'::text, 'armi.autonomous-activity-candidate.v3'::text, 'armi.activity-attention-candidate.v1'::text, 'armi.activity-attention-candidate.v2'::text, 'armi.activity-attention-candidate.v3'::text, 'armi.activity-attention-candidate.v4'::text, 'armi.activity-internal-work-candidate.v1'::text, 'armi.activity-internal-work-candidate.v2'::text, 'armi.activity-internal-work-candidate.v3'::text, 'armi.sleep-decision-candidate.v1'::text, 'armi.maintenance-work-candidate.v1'::text, 'armi.owner-reflection-candidate.v1'::text, 'armi.other-human-dialogue-candidate.v1'::text, 'armi.other-human-dialogue-candidate.v2'::text, 'armi.other-human-dialogue-candidate.v3'::text, 'armi.other-human-dialogue-candidate.v4'::text, 'armi.other-human-dialogue-candidate.v5'::text, 'armi.other-human-dialogue-candidate.v6'::text, 'armi.visual-observation-candidate.v1'::text]))),
...
CREATE TABLE armi.cognitive_candidate_validations (
    ...
    CONSTRAINT cognitive_candidate_validation_candidate_contract_version_check CHECK ((candidate_contract_version = ANY (ARRAY['armi.cognition-candidate.v1'::text, 'armi.cognition-candidate.v2'::text, 'armi.cognition-candidate.v3'::text, 'armi.cognition-candidate.v4'::text, 'armi.cognition-candidate.v5'::text, 'armi.cognition-candidate.v6'::text, 'armi.cognition-candidate.v7'::text, 'armi.creator-dialogue-candidate.v5'::text, 'armi.creator-dialogue-candidate.v6'::text, 'armi.creator-dialogue-candidate.v7'::text, 'armi.creator-dialogue-candidate.v8'::text, 'armi.creator-dialogue-candidate.v9'::text, 'armi.creator-dialogue-candidate.v10'::text, 'armi.creator-dialogue-candidate.v11'::text, 'armi.creator-dialogue-candidate.v12'::text, 'armi.creator-dialogue-candidate.v13'::text, 'armi.creator-dialogue-candidate.v14'::text, 'armi.creator-dialogue-candidate.v15'::text, 'armi.creator-dialogue-candidate.v16'::text, 'armi.creator-dialogue-candidate.v17'::text, 'armi.creator-dialogue-candidate.v18'::text, 'armi.creator-dialogue-candidate.v19'::text, 'armi.creator-dialogue-candidate.v20'::text, 'armi.creator-dialogue-candidate.v21'::text, 'armi.creator-dialogue-candidate.v22'::text, 'armi.creator-dialogue-aggregate.v1'::text, 'armi.creator-dialogue-aggregate.v2'::text, 'armi.creator-dialogue-aggregate.v3'::text, 'armi.autonomous-activity-candidate.v1'::text, 'armi.autonomous-activity-candidate.v2'::text, 'armi.autonomous-activity-candidate.v3'::text, 'armi.activity-attention-candidate.v1'::text, 'armi.activity-attention-candidate.v2'::text, 'armi.activity-attention-candidate.v3'::text, 'armi.activity-attention-candidate.v4'::text, 'armi.activity-internal-work-candidate.v1'::text, 'armi.activity-internal-work-candidate.v2'::text, 'armi.activity-internal-work-candidate.v3'::text, 'armi.sleep-decision-candidate.v1'::text, 'armi.maintenance-work-candidate.v1'::text, 'armi.owner-reflection-candidate.v1'::text, 'armi.other-human-dialogue-candidate.v1'::text, 'armi.other-human-dialogue-candidate.v2'::text, 'armi.other-human-dialogue-candidate.v3'::text, 'armi.other-human-dialogue-candidate.v4'::text, 'armi.other-human-dialogue-candidate.v5'::text, 'armi.other-human-dialogue-candidate.v6'::text, 'armi.visual-observation-candidate.v1'::text]))),
...
--
-- Name: mood_affective_events; Type: TABLE; Schema: armi; Owner: -
--

CREATE TABLE armi.mood_affective_events (
    mood_affective_event_id uuid NOT NULL,
    subject_id uuid NOT NULL,
    ...
    CONSTRAINT mood_affective_events_components_check CHECK (((jsonb_typeof(components) = 'array'::text) AND ((jsonb_array_length(components) >= 1) AND (jsonb_array_length(components) <= 3)))),
    CONSTRAINT mood_affective_events_importance_check CHECK ((((importance >= 5) AND (importance <= 100)) AND (((importance)::integer % 5) = 0))),
    CONSTRAINT mood_affective_events_mood_affective_event_id_check CHECK ((uuid_extract_version(mood_affective_event_id) = 7)),
    CONSTRAINT mood_affective_events_privacy_scope_check CHECK ((privacy_scope = 'private'::text))
);
...
CREATE TABLE armi.mood_appraisal_events (
    ...
    CONSTRAINT mood_appraisal_events_derivation_version_check CHECK ((derivation_version = ANY (ARRAY['cpm-fuzzy.v1'::text, 'cpm-fuzzy.v2'::text]))),
...
CREATE TABLE armi.mood_revisions (
    ...
    CONSTRAINT mood_revisions_payload_check CHECK (((((semantic_payload ->> 'schema_version'::text) = 'armi.mood.v1'::text) AND (semantic_payload ?& ARRAY['emotions'::text, 'mood'::text, 'schema_version'::text]) AND ((semantic_payload - ARRAY['emotions'::text, 'mood'::text, 'schema_version'::text]) = '{}'::jsonb) AND (jsonb_typeof((semantic_payload -> 'emotions'::text)) = 'array'::text) AND (jsonb_typeof((semantic_payload -> 'mood'::text)) = ANY (ARRAY['string'::text, 'null'::text]))) OR (((semantic_payload ->> 'schema_version'::text) = 'armi.mood.v2'::text) AND (semantic_payload ?& ARRAY['dynamics_version'::text, 'home_base'::text, 'schema_version'::text]) AND ((semantic_payload - ARRAY['dynamics_version'::text, 'home_base'::text, 'schema_version'::text]) = '{}'::jsonb) AND ((semantic_payload ->> 'dynamics_version'::text) = 'exponential.v1'::text) AND (jsonb_typeof((semantic_payload -> 'home_base'::text)) = 'object'::text) AND ((semantic_payload -> 'home_base'::text) ?& ARRAY['valence'::text, 'arousal'::text, 'dominance'::text]) AND (((semantic_payload -> 'home_base'::text) - ARRAY['valence'::text, 'arousal'::text, 'dominance'::text]) = '{}'::jsonb) AND (((((semantic_payload -> 'home_base'::text) ->> 'valence'::text))::integer >= '-100'::integer) AND ((((semantic_payload -> 'home_base'::text) ->> 'valence'::text))::integer <= 100)) AND (((((semantic_payload -> 'home_base'::text) ->> 'arousal'::text))::integer >= '-100'::integer) AND ((((semantic_payload -> 'home_base'::text) ->> 'arousal'::text))::integer <= 100)) AND (((((semantic_payload -> 'home_base'::text) ->> 'dominance'::text))::integer >= '-100'::integer) AND ((((semantic_payload -> 'home_base'::text) ->> 'dominance'::text))::integer <= 100))) OR (((semantic_payload ->> 'schema_version'::text) = 'armi.mood.v3'::text) AND (semantic_payload ?& ARRAY['dynamics_version'::text, 'derivation_version'::text, 'home_base'::text, 'schema_version'::text]) AND ((semantic_payload - ARRAY['dynamics_version'::text, 'derivation_version'::text, 'home_base'::text, 'schema_version'::text]) = '{}'::jsonb) AND ((semantic_payload ->> 'dynamics_version'::text) = 'recency-reappraisal.v1'::text) AND ((semantic_payload ->> 'derivation_version'::text) = ANY (ARRAY['cpm-fuzzy.v1'::text, 'cpm-fuzzy.v2'::text])) AND (jsonb_typeof((semantic_payload -> 'home_base'::text)) = 'object'::text) AND ((semantic_payload -> 'home_base'::text) ?& ARRAY['valence'::text, 'arousal'::text, 'dominance'::text]) AND (((semantic_payload -> 'home_base'::text) - ARRAY['valence'::text, 'arousal'::text, 'dominance'::text]) = '{}'::jsonb) AND (jsonb_typeof(((semantic_payload -> 'home_base'::text) -> 'valence'::text)) = 'number'::text) AND (jsonb_typeof(((semantic_payload -> 'home_base'::text) -> 'arousal'::text)) = 'number'::text) AND (jsonb_typeof(((semantic_payload -> 'home_base'::text) -> 'dominance'::text)) = 'number'::text) AND (((((semantic_payload -> 'home_base'::text) ->> 'valence'::text))::integer >= '-100'::integer) AND ((((semantic_payload -> 'home_base'::text) ->> 'valence'::text))::integer <= 100)) AND (((((semantic_payload -> 'home_base'::text) ->> 'arousal'::text))::integer >= '-100'::integer) AND ((((semantic_payload -> 'home_base'::text) ->> 'arousal'::text))::integer <= 100)) AND (((((semantic_payload -> 'home_base'::text) ->> 'dominance'::text))::integer >= '-100'::integer) AND ((((semantic_payload -> 'home_base'::text) ->> 'dominance'::text))::integer <= 100))))),
