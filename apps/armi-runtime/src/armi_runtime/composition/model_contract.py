...
CANDIDATE_VERSION = "armi.cognition-candidate.v1"
...
class CognitionCandidate(_StrictModel):
    schema_version: Literal["armi.cognition-candidate.v1"]
    disposition: Literal[
        "change",
        "no_change",
        "defer",
    ...
    understanding: Annotated[str, StringConstraints(min_length=1, max_length=1024)]
