...
def encode_result(result: CodexRunResult) -> bytes:
    value = {
        ...
        "tool_digest": result.tool_digest.to_wire(),
        ...
        "output_digest": _digest(result.output_digest),
        "usage": (
            None
