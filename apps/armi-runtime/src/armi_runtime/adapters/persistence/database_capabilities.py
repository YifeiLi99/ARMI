...
data_rights_party_fences deletion_order_retry_attempts deletion_orders
...
data_rights_party_fences deletion_items deletion_orders dialogue_decisions durable_work effect_attempts
effect_outbox_items effect_registrations effects exact_life_query_intents
...
permission_grants policy_decisions prompt_documents relationships response_admissions
