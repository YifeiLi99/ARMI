...
async def apply_life_materials(
    ...
    *,
    ...
    if set(artifact_ids) != {item.proposal_ref for item in materials}:
    ...
    for material in materials:
        ...
        artifact_id = artifact_ids[material.proposal_ref]
...
def _semantic_digest(material: CandidateLifeMaterialDraft) -> Digest:
    value = {
        "schema_version": "armi.life-material-revision.v1",
