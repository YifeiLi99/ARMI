...
OPERATION_DESCRIPTIONS = {
    ...
    "cognition_read": "List one episode's retained input/output artifacts, or read one exact artifact as paged UTF-8 text. Offsets and lengths count Unicode characters; no model execution.",
    "autonomy_status": "Read the autonomous plan, quota, outlet and current execution conditions.",
    "autonomy_history": "List autonomous opportunities and their cognition outcomes with operation references.",
    "usage_summary": "Summarize cloud API usage and official list-price estimates; no prompt access.",
...
ADMIN_OPERATIONS = (
    ...
    AdminOperation("content_write", ContentWriteRequest, "database"),
    ...
    AdminOperation("autonomy_status", EnvironmentRequest, "observe"),
    AdminOperation("autonomy_history", AutonomyHistoryRequest, "observe"),
    AdminOperation("usage_summary", UsageRequest, "observe"),
    AdminOperation("usage_list", UsageListRequest, "observe"),
