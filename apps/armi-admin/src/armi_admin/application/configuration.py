...
class AdminConfig(BaseModel):
    ...
    schema_version: Literal["armi.admin-config.v1"]
    ...
    @field_validator("database_locator")
    @classmethod
    def _database_locator(cls, value: str) -> str:
        try:
        ...
        if locator.scheme == "env" and locator.target != "ARMI_SECRET_ADMIN_DATABASE":
            raise ValueError("ADMIN-CONFIG-DATABASE-LOCATOR")
        return value
