...
表情由 80 ms 一帧的确定性矢量动画状态机生成，不使用位图或 Emoji 字体。屏幕始终保持纯黑，只绘制颜表情式的细线眼睛、小型嘴和必要的泪滴、汗滴或腮红；Mood 投影颜色作用于这些笔画，并随 `energy` 产生轻微颜色呼吸。九种在线脸分别拥有独立的换形、位移和节奏；兴奋会跳动，焦虑会抖动，悲伤带移动泪滴，害羞和开心带动态腮红。切换后的前 320 ms 逐帧淡入，离线脸保持暗灰色闭眼静止。
