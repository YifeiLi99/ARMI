...
并在 interpretation 中理解这种偏好;不生成 boundary,不扩大成停止联系,不自动建立承诺。
...
fact、boundary、commitment_change 按实际变化填写,无相应变化时省略可选字段。
没有经历时省略 social;只有经历、没有关系变化时只填写 social.experience;
