...
CREATE TABLE armi.mood_appraisal_events (
    ...
    affect_intensity smallint NOT NULL CHECK (affect_intensity BETWEEN 0 AND 100),
    affect_half_life_seconds integer NOT NULL CHECK (affect_half_life_seconds BETWEEN 900 AND 86400),
