...
GRANT SELECT ON TABLE armi.mood_assessments TO armi_admin;
GRANT SELECT ON TABLE armi.mood_assessments TO armi_runtime;
GRANT INSERT ON TABLE armi.mood_assessments TO armi_runtime;
GRANT UPDATE ON TABLE armi.mood_assessments TO armi_runtime;
