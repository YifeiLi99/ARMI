...
GRANT SELECT ON TABLE armi.event_appraisals TO armi_admin;
GRANT SELECT ON TABLE armi.event_appraisals TO armi_runtime;
GRANT INSERT ON TABLE armi.event_appraisals TO armi_runtime;
GRANT UPDATE ON TABLE armi.event_appraisals TO armi_runtime;
...
GRANT UPDATE ON TABLE armi.accepted_experiences, armi.activity_revisions, armi.life_material_revisions, armi.relationship_revisions, armi.subject_component_revisions, armi.subjective_memory_revisions TO armi_runtime;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE armi.focus_revisions TO armi_admin;
GRANT SELECT, INSERT, UPDATE ON TABLE armi.focus_revisions TO armi_runtime;
